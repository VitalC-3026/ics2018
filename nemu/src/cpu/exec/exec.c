...
make_group(gp4,
  ...
  /* 0xff */
make_group(gp5,
    EMPTY, EMPTY, EX(call_rm), EX(call),
    EMPTY, EMPTY, EX(push), EX(pop))
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x0c */	IDEXW(I2a, add, 1), IDEX(I2a, add), EMPTY, EX(2byte_esc),
  ...
  /* 0x34 */	IDEXW(I2a, add, 1), IDEX(I2a, add), EMPTY, EMPTY,
